                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>NombreGrupo</th><th>IdMateriaInterno</th><th>CapacidadMaxima</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($grupos as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->NombreGrupo }}</td><td>{{ $item->idMateriaInterno }}</td><td>{{ $item->capacidadMaxima }}</td>
                                        <td>
                                            <a href="{{ url('/grupos/' . $item->id) }}" title="View grupo"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/grupos/' . $item->id . '/edit') }}" title="Edit grupo"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>

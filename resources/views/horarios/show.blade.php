                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Semestre </th><td> {{ $horario->Semestre }} </td></tr><tr><th> NoCtrl </th><td> {{ $horario->noCtrl }} </td></tr><tr><th> NumeroOficioProrroga </th><td> {{ $horario->numeroOficioProrroga }} </td></tr>
                                </tbody>
                            </table>
                        </div>
